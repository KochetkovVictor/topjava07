...
public class UserMealsUtil {
    ...
    {
        mealsMap.put(1,mealList.get(0));
        mealsMap.put(2,mealList.get(1));
        mealsMap.put(3,mealList.get(2));
        mealsMap.put(4,mealList.get(3));
        mealsMap.put(5,mealList.get(4));
        mealsMap.put(6,mealList.get(5));
    }
